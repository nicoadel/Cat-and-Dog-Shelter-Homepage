...
<div id='main' class='containerr pb-5 pt-5'>
  ...
  <?php foreach ($newarray as $key) { ?>
    <a data-toggle="modal" data-target="#imageModal<?php echo $key["place_id"];?>"><img src='<?php echo $key['place_image'] ?>' class='img-thumbnail make_bigger mb-4' alt='Cinque Terre'></a>
