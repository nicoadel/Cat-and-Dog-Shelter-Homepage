...
<body>
        <div class="container">
         <center><h2>dog uploade</h2></center>
       
        <form action="includes_admin/upload_dogs.inc.php" method="post" class="my-4">
              <div class="form-group">
                <label for="exampleInputEmail1">dog user id :</label>
                <input type="text"
                class="form-control"
                name="dog_user_id"
                placeholder="dog user id"
                >
              </div>
   ...
   <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                > </div>
                                          <div class="form-group">
                <label for="exampleInputEmail1">dog gender:</label>
                <input type="text"
                class="form-control"
                name="gender"
                placeholder="gender"
